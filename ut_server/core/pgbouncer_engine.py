...
Every copy of UT VFX keeps its own connections open to PostgreSQL. That is fine
...
class PgBouncerEngine:
    ...
    def __init__(self, data_dir: str, db_port: int = 5440,
                 ...
                 dbname: str = "ut_vfx", db_user: str = "ut_vfx_app",
                 db_password: str = ""):
    ...
    def write_config(self, psql_exe: Optional[Path] = None) -> bool:
        ...
        lines = [
            "; Written by UT Central Server. Edits are overwritten on restart.",
            ";",
    ...
    def _render_ini(self) -> str:
        ...
        return f"""; PgBouncer - connection pooling for UT VFX
; Written by UT Central Server. Edits here are overwritten on restart;
; change the server settings instead.
;
; What this does: every copy of UT VFX connects here instead of straight to
