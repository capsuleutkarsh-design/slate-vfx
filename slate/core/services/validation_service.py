...
class ValidationService:
    """
    Bridge between Slate and Pyblish.
    ...
    def _register_plugins(self):
        ...
        # Point to the 'plugins' directory relative to this file's parent (slate)
        # Assuming layout: slate/core/services/validation_service.py -> ../../plugins
