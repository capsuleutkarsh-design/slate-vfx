...
def run_auto_migrations(active_mode: str = None, fallback_used: bool = None) -> bool:
    ...
    try:
        ...
        # Resolve root dir (D:\Soft\Slate\V0040)
        # We are in slate/core/infra/migrations/auto_migrate.py
        current_dir = os.path.dirname(os.path.abspath(__file__))
        infra_dir = os.path.dirname(current_dir)
        core_dir = os.path.dirname(infra_dir)
        slate_dir = os.path.dirname(core_dir)
        root_dir = os.path.dirname(slate_dir)
