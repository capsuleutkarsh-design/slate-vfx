...
Acts as the bridge between Slate and Olive Video Editor.
"""
...
class LineupEditorMode(QWidget):
    ...
    def _find_olive_executable(self):
        ...
        if getattr(sys, 'frozen', False):
            ...
            # file: .../slate/gui/tabs/shot_review/lineup_editor_mode.py
            # project root: .../V0040
            module_root = Path(__file__).resolve().parents[3]  # .../slate
        ...
        candidates.append(str(Path.home() / "AppData/Local/Slate Production/olive-editor/olive-editor.exe"))
        candidates.append(str(Path.home() / "AppData/Local/Slate/olive-editor/olive-editor.exe"))
    ...
    def set_shots(self, all_shots: list):
        ...
        """
        from slate.core.domain.olive_lineup import build_lineup, department_labels
    ...
    def sync_lineup(self):
        ...
        choose up front.
        """
        from slate.core.domain.olive_lineup import generate_timelines
        ...
        try:
            ...
            if not base_dir.exists():
                try:
                    ...
                    base_dir = Path.home() / "RuntimeData" / "Slate_Lineups"
                    base_dir.mkdir(parents=True, exist_ok=True)
        ...
        try:
            ...
            if not base_path or not base_path.exists():
                QMessageBox.warning(
                    ...
                    f"Expected location: {Path.home() / 'AppData' / 'Local' / 'Slate Production' / 'olive-editor' / 'olive-editor.exe'}"
                )
                return
