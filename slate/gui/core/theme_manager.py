...
class ThemeManager:
    ...
    def apply_theme(cls, app: QApplication, slate_dir: str):
        ...
        # 3. Load QSS File
        qss_path = os.path.join(slate_dir, "resources", "styles", "main.qss")
        fallback_qss = os.path.join(slate_dir, "resources", "styles.qss")
        ...
        if stylesheet:
            ...
            stylesheet = stylesheet.replace("@ICONS", cls._icon_dir(slate_dir))
