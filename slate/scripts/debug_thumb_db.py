...
DB_PATHS = [
    str(GlobalConfig.server_root() / "Database" / "slate.db") if 'GlobalConfig' in locals() else "",
    os.path.join(os.environ.get("LOCALAPPDATA", os.path.expanduser("~\\AppData\\Local")), r"Slate\Database\slate.db")
]
