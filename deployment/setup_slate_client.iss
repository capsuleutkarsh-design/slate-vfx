; Script to create installer for Slate Production tool.
...
OutputBaseFilename=setup_Slate_Studio_v{#MyAppVersion}
Compression=lzma
...
[Components]
Name: "main_soft"; Description: "Slate Main Software (Client)"; Types: client custom
...
Root: HKCU; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; ValueType: string; ValueName: "Slate"; ValueData: """{app}\{#MyAppExeName}"" --startup"; Flags: uninsdeletevalue; Components: main_soft
...
var
  ResultCode: Integer;
begin
  Exec(ExpandConstant('{sys}\taskkill.exe'), '/F /T /IM "Slate_Studio.exe"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
