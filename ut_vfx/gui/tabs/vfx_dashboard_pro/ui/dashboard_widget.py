...
class DashboardWidget(
    ...
    def refresh_connection_state(self):
        ...
        from ut_vfx.core.domain.access import is_offline_fallback
    ...
    def open_quick_look(self, shot):
        ...
        try:
            from ut_vfx.gui.widgets.quick_look import QuickLookDialog
    ...
    def review_in_rv(self, shot):
        ...
        from ut_vfx.gui.dialogs.rv_review_dialog import review_shot_in_rv
    ...
    def open_delivery_batches_dialog(self):
        ...
        if not getattr(self, "current_project", None):
            self._notify("Please select a project first.", "warning")
            return
        from ut_vfx.gui.tabs.vfx_dashboard_pro.ui.delivery_batches_dialog import (
    ...
    def _allowed_statuses(self):
        ...
        from ut_vfx.core.domain.access import artist_statuses, can_edit_dashboard
