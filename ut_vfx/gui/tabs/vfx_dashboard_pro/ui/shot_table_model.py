...
class ShotTableModel(QAbstractTableModel):
    ...
    def build_columns():
        ...
        Department columns come from ut_vfx/data/departments.json, so adding a
    ...
    def flags(self, index):
        ...
        # RBAC check
        from ut_vfx.core.domain.access import can_edit_dashboard, is_offline_fallback
    ...
    def setData(self, index, value, role=Qt.ItemDataRole.EditRole):
        ...
        try:
            ...
            from ut_vfx.core.domain.access import can_edit_dashboard
            if not can_edit_dashboard(self.user_roles):
    ...
    def _owns_department(self, shot, col_key: str) -> bool:
        ...
        """
        from ut_vfx.core.domain.access import can_edit_own_status
