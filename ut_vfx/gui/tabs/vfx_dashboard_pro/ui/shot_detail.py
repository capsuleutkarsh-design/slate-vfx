...
class ShotDetailWidget(QWidget):
    ...
    def _init_departments_section(self):
        ...
        self.depts = {}
        # Rows come from ut_vfx/data/departments.json - adding a department
    ...
    def _create_dcc_button(self, app_key: str, app_label: str, icon_name: str) -> QToolButton:
        ...
        btn.setStyleSheet(
            f"""
            QToolButton#D9635FLauncherBtn {{
                border: 1px solid {C.BORDER_DEFAULT};
                border-radius: {R.SM}px;
                background-color: {C.BG_ELEVATED};
                padding: 2px;
            }}
            QToolButton#D9635FLauncherBtn:hover {{
                border: 1px solid {C.ACCENT_PRIMARY};
                background-color: {C.BG_HOVER};
            }}
            QToolButton#D9635FLauncherBtn:pressed {{
