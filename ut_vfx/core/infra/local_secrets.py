...
from the machine instead:
    ...
    2. ut_vfx/config.json - written by setup.bat, and git-ignored
...
# ut_vfx/core/infra/local_secrets.py -> infra -> core -> ut_vfx -> repo root
...
def _candidates():
    ...
    if local_app_data:
        yield Path(local_app_data) / "UTVFX" / "config.json"
