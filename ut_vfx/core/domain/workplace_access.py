...
#
#     leave types, statuses, accrual, the sandwich rule   ut_vfx/core/domain/leave_policy.py
#     ticket categories, the priority matrix, SLA         ut_vfx/core/domain/service_desk.py
#
