...
The list now lives in data. Edit ``ut_vfx/data/departments.json`` to add,
...
def _package_data_path(filename: str) -> Path:
    """
    Locate a file in ut_vfx/data, in a source tree or a frozen build.
    ...
    try:
        ...
        candidate = files("ut_vfx.data").joinpath(filename)
