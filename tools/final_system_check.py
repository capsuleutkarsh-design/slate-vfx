...
def check_database():
    ...
    try:
        ...
        print("      (Try running 'python tools/setup_credentials.py' if this is an Auth error)")
...
def check_python_dependencies():
    ...
    deps = ['psycopg2', 'keyring', 'cryptography', 'matplotlib', 'seaborn', 'PySide6', 'slate']
    for dep in deps:
        try:
            __import__(dep)
...
if __name__ == "__main__":
    print("\nSlate - SYSTEM HEALTH DIAGNOSTIC")
