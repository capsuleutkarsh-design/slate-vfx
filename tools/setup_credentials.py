"""
Slate - Credential Setup Utility
...
def main():
    parser = argparse.ArgumentParser(description="Configure Slate database credentials")
    ...
    print("\n" + "="*60)
    print("Slate - DATABASE CREDENTIALS SETUP")
    print("="*60)
