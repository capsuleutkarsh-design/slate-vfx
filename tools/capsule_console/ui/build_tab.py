...
class BuildTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.target_combo.addItem("🎬 UT VFX Studio", "vfx")
        self.target_combo.addItem("🏢 UT Studio Operations", "ops")
        self.target_combo.addItem("🖥️ UT Central Server", "server")
        ...
        self.btn_vfx.setToolTip("Direct full build for UT VFX Studio (Exe + Setup)")
        ...
        self.btn_ops.setToolTip("Direct full build for UT Studio Operations (Exe + Setup)")
        ...
        self.btn_server.setToolTip("Direct full build for UT Central Server (Exe + Setup)")
    ...
    def run_build_exe(self):
        ...
        # Use onedir to build unified dist/UTVFX with all executables
