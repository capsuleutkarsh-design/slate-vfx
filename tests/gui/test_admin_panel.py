...
def clean_admin_panel(qtbot):
    ...
    app = QApplication.instance()
    if app:
        from slate.gui.admin_panel import AdminPanelTab
...
class TestAdminPanelAccess:
    ...
    @patch('slate.gui.admin_panel.UserManager')
...
class TestSystemSettings:
    ...
    @patch('slate.gui.admin_panel.ConfigManager')
...
class TestSystemMonitoring:
    ...
    @patch('slate.gui.admin_panel.performance_monitor')
...
class TestDatabaseManagement:
    ...
    @patch('slate.gui.admin_panel.DatabaseManager')
